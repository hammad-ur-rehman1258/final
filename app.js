...
const firebaseConfig = {
  apiKey: "AIzaSyBakfJVm9rPP7bUC-B37z5wEJcGTD2xxRk",
  authDomain: "hammad-blogwebsite.firebaseapp.com",
  projectId: "hammad-blogwebsite",
  storageBucket: "hammad-blogwebsite.appspot.com",
  messagingSenderId: "966405249890",
  appId: "1:966405249890:web:1343cce6b4562e307e6a3b",
  measurementId: "G-9SE5VW2JX0"
};
// Initialize Firebase
  ...
  const unsubscribe = onSnapshot(q, (querySnapshot) => {
    ...
    const blogsHTML = blogData
      .map((blog) => {
        ...
        return `
          <div class="collapse bg-base-200 bpost" style="background-color: beige">
            <input type="radio" name="my-accordion-1" />
            <div class="collapse-title text-xl font-medium">
              ${blog.title}
            </div>
            <div class="collapse-content">
              <p>${blog.text.substring(0, 250)} <a style="color: Blue;" class="readMore" data-createdAt="${timestamp}" data-blog-id="${blog.id}"><u>Read More...</u></a></p>
...
const setNavBar = () => {
  owner.innerHTML = `<div class="navbar bg-base-100">
        <div class="flex-1">
            <a href="index.html" class="btn btn-ghost text-xl">Blog Managment</a>
        </div>
        <div class="blogPost">
